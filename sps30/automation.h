...
//template<typename... Ts> class StopMeasureAction : public Action<Ts...> {
// public:
//  explicit StopMeasureAction(SPS30Component *sps30) : sps30_(sps30) {}

//  void play(Ts... x) override { this->sps30_->stop_measure(); }
